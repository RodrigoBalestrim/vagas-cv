...
function gerarCurriculoPDF(vaga) {
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.font('Helvetica-Bold').fontSize(18).fillColor('#111111').text(CANDIDATO.nome);
      doc.moveDown(0.2);
      doc.font('Helvetica-Bold').fontSize(10.5).fillColor('#111111').text(titulo);
      doc.moveDown(0.2);
      ...
      const bullet = (t) => { doc.text('•  ' + t, { lineGap: 2 }); doc.moveDown(0.08); };
